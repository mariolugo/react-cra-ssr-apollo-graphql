    ...
    return (
      <Grid container spacing={16} className={classes.marginTop15}>
        ...
        <Grid item xs={8}>
            ...
            {typeof user.facebookId !== "undefined" &&
              user.facebookId === null && (
                <Grid
                  container
                  spacing={16}
                  className={classes.paddingSides10}
                ...
                >
                  ...
                  <Grid item xs={12} sm={8}>
                    <Typography
                      ...
                      align="left"
                    >
                      Conecta tu perfil a Facebook para acceder de manera más
                      simple y rápida.
                    </Typography>
                  </Grid>
                  <Grid
                        ...
                        return (
                          <Chip
                            ...
                            onDelete={() => {
                              ...
                              let prop = { ...user };
                              prop.userPersonality = userPersonality;
          ...
          {typeof user.userLifeStyle !== "undefined" &&
            Array.isArray(user.userLifeStyle) &&
                        ...
                        return (
                          <Chip
                            ...
                            onDelete={() => {
                              ...
                              let prop = { ...user };
                              prop.userLifeStyle = userLifeStyle;
          ...
          {typeof user.userMusic !== "undefined" &&
            Array.isArray(user.userMusic) &&
          ...
          {typeof user.userSports !== "undefined" &&
            Array.isArray(user.userSports) &&
          ...
          {typeof user.userMovies !== "undefined" &&
            Array.isArray(user.userMovies) &&
          ...
          >
            ...
            <div style={{ width: 430 }} className={classes.drawerContainer2}>
              ...
              <Typography
                ...
                gutterBottom
                className={classes.textSubDrawer}
              >
                Elige las opciones para cada categoría
              </Typography>
              <ExpansionPanel
                className={classes.expansionPanel}
                expanded={selectedDrawerTab === "personality"}
                onChange={this._handleDrawerTab("personality")}
              >
                <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                  ...
                  <Typography
                    ...
                    style={{ fontWeight: "lighter" }}
                    gutterBottom
                    className={classes.textTabTitle}
                  >
                    Personalidad
                  </Typography>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails style={{ display: "block" }}>
                  {userTags.hasOwnProperty("personality") &&
                    userTags.personality.length > 0 &&
                    userTags.personality.map((tag, index) => {
                      if (
                        userPersonality &&
                        userPersonality.indexOf(tag) !== -1
                      ) {
                        return (
                          <Chip
                            key={index}
              ...
              <ExpansionPanel
                className={classes.expansionPanel}
                expanded={selectedDrawerTab === "lifestyle"}
                onChange={this._handleDrawerTab("lifestyle")}
              >
                <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                  <Avatar>
                    <BeachAccessIcon />
                ...
                <ExpansionPanelDetails style={{ display: "block" }}>
                  {userTags.hasOwnProperty("lifestyle") &&
                    userTags.lifestyle.length > 0 &&
                    userTags.lifestyle.map((tag, index) => {
              ...
              <ExpansionPanel
                className={classes.expansionPanel}
                expanded={selectedDrawerTab === "music"}
                onChange={this._handleDrawerTab("music")}
              >
                <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                  <Avatar>
                    <HeadsetIcon />
                ...
                <ExpansionPanelDetails style={{ display: "block" }}>
                  {userTags.hasOwnProperty("music") &&
                    userTags.music.length > 0 &&
                    userTags.music.map((tag, index) => {
              ...
              <ExpansionPanel
                className={classes.expansionPanel}
                expanded={selectedDrawerTab === "sports"}
                onChange={this._handleDrawerTab("sports")}
              >
                <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                  <Avatar>
                    <FitnessCenterIcon />
                ...
                <ExpansionPanelDetails style={{ display: "block" }}>
                  {userTags.hasOwnProperty("sports") &&
                    userTags.sports.length > 0 &&
                    userTags.sports.map((tag, index) => {
              ...
              <ExpansionPanel
                className={classes.expansionPanel}
                expanded={selectedDrawerTab === "movies"}
                onChange={this._handleDrawerTab("movies")}
              >
                <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                  <Avatar>
                    <MovieFilterIcon />
                ...
                <ExpansionPanelDetails style={{ display: "block" }}>
                  {userTags.hasOwnProperty("movies") &&
                    userTags.movies.length > 0 &&
                    userTags.movies.map((tag, index) => {
            ...
            <div style={{ width: 430 }}>
              <div
                ...
                style={{ width: 410, paddingLeft: 11, paddingRight: 11 }}
              >
                <Grid container spacing={16} className={classes.marginTop15}>
                  <Grid item xs={12}>
                    <Button
